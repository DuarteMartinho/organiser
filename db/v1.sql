...
-- =========================
-- 9. Group Invites (Security Enhancement)
-- =========================
CREATE TABLE group_invites (
    id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
    group_id UUID REFERENCES groups(id) ON DELETE CASCADE,
    created_by UUID REFERENCES users(id) ON DELETE SET NULL,
    code VARCHAR(20) NOT NULL UNIQUE, -- Short, shareable code
    max_uses INT DEFAULT 1, -- How many times it can be used
...
-- =========================
-- 10. Group Bans (Block unwanted users)
-- =========================
...
CREATE INDEX idx_group_bans_lookup ON group_bans(group_id, user_id);